...
RSpec.describe "/labels", type: :request do
  ...
  # LabelsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get labels_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Label" do
        expect {
          post labels_url,
               params: { label: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      ...
      it "renders a JSON response with errors for the new label" do
        post labels_url,
             params: { label: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested label" do
        ...
        patch label_url(label),
              params: { label: new_attributes }, headers: valid_headers, as: :json
        label.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested label" do
      label = Label.create! valid_attributes
      expect {
        delete label_url(label), headers: valid_headers, as: :json
      }.to change(Label, :count).by(-1)
    end
  end
end
